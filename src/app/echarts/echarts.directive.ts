...
export const ECHARTS_CONFIG = new InjectionToken<EchartsConfig>('NGX_ECHARTS_CONFIG');
...
export class EchartsDirective implements OnChanges, OnDestroy, OnInit, DoCheck, AfterViewInit {
  @Input() options: any;
  @Input() theme: string;
  ...
  constructor(
    @Inject(ECHARTS_CONFIG) config: EchartsConfig,
