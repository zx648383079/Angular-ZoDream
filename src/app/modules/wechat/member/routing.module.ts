...
import { WechatMemberComponent } from './wechat-member.component';
...
const routes: Routes = [
    ...
    {
        path: ':wid',
        component: WechatMemberComponent,
        children: [
            {
                path: 'user/group',
...
export class WechatMemberRoutingModule {}

export const wechatMemberRoutingComponents = [
    WechatMemberComponent, AccountComponent, EditAccountComponent, LogComponent,
