...
export class PresaleComponent implements OnInit {
    ...
    public readonly items = signal<IActivity<any>[]>([]);
    ...
    public goPage(page: number) {
        ...
        this.service.presaleList(queries).subscribe(res => {
    ...
    public tapRemove(item: any) {
        this.toastrService.confirm('确定删除“' + item.name + '”活动？', () => {
            this.service.presaleRemove(item.id).subscribe(res => {
                if (!res.data) {
                    return;
                }
