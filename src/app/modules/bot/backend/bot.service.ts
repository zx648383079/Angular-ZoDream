...
export class BotService {
    ...
    public accountRemove(id: any) {
        return this.http.delete<IDataOne<boolean>>('bot/admin/account/delete', {params: {id, wid: this.baseId}});
    }

    public mediaList(params: any) {
        return this.http.get<IPage<IBotMedia>>('bot/admin/media', {params: {...params, wid: this.baseId}});
    }

    public media(id: any) {
        return this.http.get<IBotMedia>('bot/admin/media/detail', {params: {id, wid: this.baseId}});
    }
    ...
    public mediaRemove(id: any) {
        return this.http.delete<IDataOne<boolean>>('bot/admin/media/delete', {params: {id, wid: this.baseId}});
    }
    ...
    public menuList(params: any) {
        return this.http.get<IPage<IBotMenuItem>>('bot/admin/menu', {params: {...params, wid: this.baseId}});
    }
    ...
    public menuRemove(id: any) {
        return this.http.delete<IDataOne<boolean>>('bot/admin/menu/delete', {params: {id, wid: this.baseId}});
    }
    ...
    public replyList(params: any) {
        return this.http.get<IPage<IBotReply>>('bot/admin/reply', {params: {...params, wid: this.baseId}});
    }

    public reply(id: any) {
        return this.http.get<IBotReply>('bot/admin/reply/detail', {params: {id, wid: this.baseId}});
    }
    ...
    public replyRemove(id: any) {
        return this.http.delete<IDataOne<boolean>>('bot/admin/reply/delete', {params: {id, wid: this.baseId}});
    }

    public wxTemplateList(params: any) {
        return this.http.get<IPage<IBotReplyTemplate>>('bot/admin/reply/template', {params: {...params, wid: this.baseId}});
    }

    public wxTemplate(id: string) {
        return this.http.get<IBotReplyTemplate>('bot/admin/reply/template_detail', {params: {id, wid: this.baseId}});
    }
    ...
    public wxTemplateAsync() {
        return this.http.post<IDataOne<boolean>>('bot/admin/reply/refresh_template', {wid: this.baseId});
    }

    public userList(params: any) {
        return this.http.get<IPage<IBotUser>>('bot/admin/user', {params: {...params, wid: this.baseId}});
    }

    public user(id: any) {
        return this.http.get<any>('bot/admin/user/detail', {params: {id, wid: this.baseId}});
    }
    ...
    public userRemove(id: any) {
        return this.http.delete<IDataOne<boolean>>('bot/admin/user/delete', {params: {id, wid: this.baseId}});
    }

    public userAsync() {
        return this.http.post<IDataOne<boolean>>('bot/admin/user/refresh', {wid: this.baseId});
    }

    public userGroupList(params: any) {
        return this.http.get<IPage<IBotUserGroup>>('bot/admin/user/group', {params: {...params, wid: this.baseId}});
    }
    ...
    public userGroupRemove(id: any) {
        return this.http.delete<IDataOne<boolean>>('bot/admin/user/group_delete', {params: {id, wid: this.baseId}});
    }

    public logList(params: any) {
        return this.http.get<IPage<any>>('bot/admin/log', {params: {...params, wid: this.baseId}});
    }

    public logRemove(id: any) {
        return this.http.delete<IDataOne<boolean>>('bot/admin/log/delete', {params: {id, wid: this.baseId}});
    }

    public qrcodeList(params: any) {
        return this.http.get<IPage<IBotQr>>('bot/admin/qrcode', {params: {...params, wid: this.baseId}});
    }

    public qrcode(id: any) {
        return this.http.get<IBotQr>('bot/admin/qrcode/detail', {params: {id, wid: this.baseId}});
    }
    ...
    public qrcodeRemove(id: any) {
        return this.http.delete<IDataOne<boolean>>('bot/admin/qrcode/delete', {params: {id, wid: this.baseId}});
    }
